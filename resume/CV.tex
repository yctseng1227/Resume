...
%      {Institution of Study}{Where it is located}
    \CVSubheading
      {M.S. in Computer Science and Engineering $|$ \emph{\small{Information Security}}}{Aug. 2019 -- Jan. 2022 (expected)}
    ...
    \CVSubheading
      {B.S. in Computer Science and Information Engineering}{Aug. 2015 -- May 2016}
