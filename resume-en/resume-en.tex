...
\begin{center}
  ...
  \vspace{3mm}
  \faGlobe{ \href{https://blog.cyris.tw}{blog.cyris.tw}} $|$
  \faEnvelopeO{ \href{mailto:cyris.tseng@gmail.com}{cyris.tseng@gmail.com}} $|$
  % Be sure to use a professional *personal* email address
  % you should adjust you linked in profile name to be professional and recognizable
  \faGithub{ \href{https://github.com/yctseng1227}{yctseng1227}} \\
...
\begin{comment}
  ...
  %      \CVItemListEnd
      ...
      \CVSubheading
        ...
        {Information Security Club, National Sun Yat-sen University}{Kaohsiung, Taiwan}
        \CVItemListStart
      ...
      \CVSubheading
        ...
        {Competitive Programming Club, National University of Kaohsiung}{Kaohsiung, Taiwan}
        \CVItemListStart
...
%      {Institution of Study}{Where it is located}
    ...
    \CVSubheading
      {B.S. in Computer Science and Information Engineering}{Aug. 2015 -- Jul. 2016}
...
% %      {Short Description}{}
    \CVSubheading
      {Malware Analysis Training}{June 2023}
...
\begin{comment}
  ...
  % %      {School}{Where}
      ...
      \CVSubheading
        ...
        {Cryptology and Information Security Conference (CISC 2020)}{Kaohsiung, Taiwan}
    \CVSubHeadingListEnd
...
\section{Skills}
 \begin{itemize}[leftmargin=0.5cm, label={}]
    \small{\item{
      ...
      % \textbf{Had semi-finished works}{: PHP, SQL, Jenkins} \\
